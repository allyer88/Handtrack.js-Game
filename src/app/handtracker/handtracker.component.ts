  ...
  runDetection(){
    if (this.model != null){
      let predictions = this.model.detect(this.video.nativeElement).then((predictions: any) => {
            ...
            if(openhands == 1 && pointing  == 1) this.detectedGesture = "Open Hand and Point Hand";
            else if (openhands > 1) this.detectedGesture = "Two Open Hands";
            else if(openhands == 1) this.detectedGesture = "Open Hand";
            
            if(closedhands == 1 && pointing  == 1) this.detectedGesture = "Closed Hand and Point Hand";
            ...
            else if(pointing == 1 && openhands !=1 && closedhands!=1) this.detectedGesture = "Hand Pointing";
